...
const Footer = () => {
  return (
    <div className='rounded-div mt-8 pt-8 text-primary'>
        ...
        <div className='flex justify-evenly w-full md:max-w-[300px] uppercase'>
          <div>
            ...
            <ul>
              ...
              <li className='text-sm py-2'>API Strategy</li>
      ...
      <p className='text-base text-center py-4'><span className='font-bold'>Powered</span> by <span className='text-accent font-bold'>Coin Gecko</span></p>
    </div>
  );
};
